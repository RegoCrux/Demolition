...
namespace Demolition.Models
{
    ...
    partial void OnAppIDChanged();
		...
		[Column(Storage="_Payload", CanBeNull=false)]
		...
		[Column(Storage="_AppID", DbType="Int", IsDbGenerated=true)]
		...
		[Association(Name="App_Industry", Storage="_App", ThisKey="AppID", OtherKey="Id", IsForeignKey=true)]
		public App App
		{
			get
			{
	...
	public partial class App : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<Industry> _Industries;
    ...
    partial void OnIdChanged();
		...
		{
			this._Instances = new EntitySet<Instance>(new Action<Instance>(this.attach_Instances), new Action<Instance>(this.detach_Instances));
			this._Industries = new EntitySet<Industry>(new Action<Industry>(this.attach_Industries), new Action<Industry>(this.detach_Industries));
			OnCreated();
		}
		...
		[Association(Name="App_Industry", Storage="_Industries", ThisKey="Id", OtherKey="AppID")]
		public EntitySet<Industry> Industries
		{
			get
			{
		...
		private void attach_Industries(Industry entity)
		{
			this.SendPropertyChanging();
			entity.App = this;
		}
		
		private void detach_Industries(Industry entity)
		{
			this.SendPropertyChanging();
			entity.App = null;
		}
